...
- Support-expectation disclaimer: both READMEs, the five `docs/` pages, `CONTRIBUTING.md`, and `SECURITY.md` now close with a statement that the project makes no guarantees about update frequency, issue resolution timelines, or long-term support (in Chinese in `README.zh-CN.md`, English elsewhere).
